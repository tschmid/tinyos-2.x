...
my @apps = (
	...
	{"name" => "apps/tests/TestRestoreTcb", "variant" => "normal", "make" => "make sam3u_ek debugopt threads", "expected" => "LEDs 1-3 all light up"},
	{"name" => "apps/tests/TestRestoreTcb", "variant" => "protected", "make" => "make sam3u_ek debugopt threads mpu", "expected" => "LEDs 1-3 all light up"},
	{"name" => "apps/tests/TestMpuProtection", "variant" => "normal", "make" => "make sam3u_ek debugopt threads", "expected" => "LED 0 lights up, then LED 1 (green) lights up (meaning successful write to other thread's data)"},
	{"name" => "apps/tests/TestMpuProtection", "variant" => "protected", "make" => "make sam3u_ek debugopt threads mpu", "expected" => "LED 0 lights up, then LED 2 (red) lights up (meaning the MPU trapped)"},
	{"name" => "apps/tests/TestMpuProtectionSyscall", "variant" => "normal", "make" => "make sam3u_ek debugopt threads", "expected" => "LED 0 is blinking (meaning it is sending UART packets)"},
	{"name" => "apps/tests/TestMpuProtectionSyscall", "variant" => "protected", "make" => "make sam3u_ek debugopt threads mpu", "expected" => "LED 0 is blinking (meaning it is sending UART packets)"},
);
