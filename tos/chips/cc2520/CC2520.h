...
typedef nx_struct cc2520x_header_t
{
	nxle_uint8_t length;
} cc2520x_header_t;

typedef struct cc2520x_metadata_t
{
	uint8_t lqi;
	union
	{
...
static cc2520_agctrl1_t cc2520_agctrl1_default = {.value = 0x11};
...
enum cc2520_spi_command_enums
{
    ...
    CC2520_CMD_SOSCOFF        = 0x46, //
    CC2520_CMD_SFLUSHRX       = 0x47, //
    CC2520_CMD_SFLUSHRX       = 0x48, //
    ...
    CC2520_CMD_REGISTER_MASK  = 0x3F, //
    CC2520_CMD_REGISTER_READ  = 0x80, // REGRD
    CC2520_CMD_REGISTER_WRITE = 0xC0, // REGWR
};
