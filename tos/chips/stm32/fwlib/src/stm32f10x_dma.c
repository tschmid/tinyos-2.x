...
#define DMA_Channel1_IT_Mask    ((uint32_t)0x0000000F)
#define DMA_Channel2_IT_Mask    ((uint32_t)0x000000F0)
#define DMA_Channel3_IT_Mask    ((uint32_t)0x00000F00)
#define DMA_Channel4_IT_Mask    ((uint32_t)0x0000F000)
#define DMA_Channel5_IT_Mask    ((uint32_t)0x000F0000)
#define DMA_Channel6_IT_Mask    ((uint32_t)0x00F00000)
#define DMA_Channel7_IT_Mask    ((uint32_t)0x0F000000)
...
FlagStatus DMA_GetFlagStatus(uint32_t DMA_FLAG)
{
  ...
  if ((DMA->ISR & DMA_FLAG) != (uint32_t)RESET)
  {
    /* DMA_FLAG is set */
    bitstatus = SET;
  }
...
ITStatus DMA_GetITStatus(uint32_t DMA_IT)
{
  ...
  if ((DMA->ISR & DMA_IT) != (uint32_t)RESET)
  {
    /* DMA_IT is set */
    bitstatus = SET;
  }
